...
void main () {
  ...
  draw(vec3(mod(cn.z*20.,1.)*2., mod(cn.z*31.,1.)*.8, .4+mod(cn.z*12.,1.)*.6)+cnoise((uv*rotate(cn.z*20.))*vec2(249.,40.))/13.,S(.3-abs(cnoise(uv*9.)*1.),1.0-abs(cnoise(uv*9.)*1.),sin((uv*rotate(cn.z*20.) +cnoise(uv*90.)/1990.*0.).x*220.) -S(.10,.02,cn.x) -S(.9,.93,ngon(uv, vec2(0.),4))*2.2 ));
